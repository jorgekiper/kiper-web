...
MySQL - 5.5.5-10.4.21-MariaDB : Database - db_kip3r_web
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_kip3r_web` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `backend_access_log`(`id`,`user_id`,`ip_address`,`created_at`,`updated_at`) values (1,1,'127.0.0.1','2021-11-09 14:50:30','2021-11-09 14:50:30');
...
insert  into `backend_users`(`id`,`first_name`,`last_name`,`login`,`email`,`password`,`activation_code`,`persist_code`,`reset_password_code`,`permissions`,`is_activated`,`role_id`,`activated_at`,`last_login`,`created_at`,`updated_at`,`deleted_at`,`is_superuser`) values (1,'Kiper','Web','admin_dev','jorge@kiper.com','$2y$10$G80P/nA/rhwy3cMyPK2ACeZfhOJHcYj0/biX9tNmV2iZEDc4NyqHa',NULL,'$2y$10$P649aeLNYeQjsouR46BZouivWAokfuMFMBa21rraf3ew9dEfUHK8q',NULL,'',1,2,NULL,'2021-11-09 14:50:30','2021-11-09 14:49:01','2021-11-09 14:50:30',NULL,1);
...
insert  into `system_files`(`id`,`disk_name`,`file_name`,`file_size`,`content_type`,`title`,`description`,`field`,`attachment_id`,`attachment_type`,`is_public`,`sort_order`,`created_at`,`updated_at`) values (1,'618a907dba21f497234031.svg','kiper.svg',2945,'image/svg',NULL,NULL,'logo','1','Backend\\Models\\BrandSetting',1,1,'2021-11-09 15:15:09','2021-11-09 15:21:25'),(2,'618a93751e563627716711.png','kiper_logo.png',2080,'image/png',NULL,NULL,'avatar','1','Backend\\Models\\User',1,2,'2021-11-09 15:27:49','2021-11-09 15:27:54');
...
insert  into `system_parameters`(`id`,`namespace`,`group`,`item`,`value`) values (1,'system','update','count','0'),(2,'system','core','hash','\"652ebd026445ccaeb3ba083f00830dc0\"'),(3,'system','core','build','\"473\"'),(4,'system','update','retry','1636555832'),(5,'cms','theme','active','\"kiper\"');
